...
const WelcomeEmail = ({
	userName = "User",
	userEmail = "amazingemail@gmail.com",
    ...
    <Html>
      <Head />
      <Preview>Welcome to WonderLady!</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            <Img
              src={`${BASE_URL}/woman-6.jpg`}
          ...
          <Section style={global.defaultPadding}>
            <Text style={footer.text}>
              © {new Date().getFullYear()} WonderLady, Inc. All Rights Reserved.
            </Text>
          </Section>
        </Container>
      </Body>
...
// 		<Html>
// 			<Head />
// 			<Preview>Welcome to OnlyWoman!</Preview>
// 			<Body style={main}>
// 				<Container style={container}>
// 					<Section style={message}>
// 						<Img
// 							// src={`${BASE_URL}/horse-1.png`}
// 							src={`https://i.ibb.co/CV1mKKY/womam-5.png`}
// 							width='600'
// 							height='400'
// 							alt='welcome icon'
// 							style={{ margin: "auto", borderRadius: 10 }}
// 						/>
// 						<Heading style={{ ...global.heading }}>Welcome to OnlyWoman!</Heading>
// 						<Text style={global.text}>Hello {userName},</Text>
// 						<Text style={global.text}>
...
// 					<Section style={global.defaultPadding}>
// 						<Text style={footer.text}>
// 							© {new Date().getFullYear()} OnlyWoman, Inc. All Rights Reserved.
// 						</Text>
// 					</Section>
// 				</Container>
// 			</Body>
